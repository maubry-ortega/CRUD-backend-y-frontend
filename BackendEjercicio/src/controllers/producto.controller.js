import producto from '../services/producto.service.js';


export const crearProductoC = async function (req, res) {
...
export const ListarProductosC = async function (req, res) {
    try {
...
export const ListarProductosIdC = async function (req, res) {
...
export const ActualizarProductoC = async function (req, res) {
    const { id } = req.params;
    const ProductoData = req.body
    try {
...
export const EliminarProductoC = async function (req, res) {
    const id = req.params.id;
