import { CrearRol, ListarUsuRol, EditRol } from '../services/rol.services.js';
import validarCamposRequeridos from '../middleware/camposRequeridos.js';


export const EditRolC = async function (req, res) {
    try {
...
// export const ActulizarRolC = async function (req, res) {
//     try{
//         const rolDatos = req.body;
//         const idRol = req.params.id;
...
export const ListarUsuRolC = async function (req, res) {
    try {
...
export const CrearRolC = async function (req, res) {
    try {
